...
requirements: devenv ## runs pip-tools to build requirements.txt that will be installed in the JupyterLab
	...
	pip-compile kernels/jupyter_axondeepseg/requirements.in --resolver=backtracking --output-file kernels/jupyter_axondeepseg/requirements.txt
...
replay: .cookiecutterrc ## re-applies cookiecutter
	# Replaying /home/iavarone/repos/cookiecutter-osparc-jupyterlab-service/ ...
	@cookiecutter --no-input --overwrite-if-exists \
		--config-file=$< \
		--output-dir="$(abspath $(CURDIR)/..)" \
		"/home/iavarone/repos/cookiecutter-osparc-jupyterlab-service/"
